  ...
  \begin{scriptsize}
    ...
    \begin{columns}
      ...
      \begin{itemize}\setlength\itemsep{1.9ex}        
        \item[o] {\bf High confidence that climate change is causing changes in ecosystem structure, geographic ranges and timing of seasonal life cycles}
      \end{itemize}
...
\begin{frame}
  ...
  \begin{scriptsize}
    ...
    \begin{columns}
      \column{1.0\textwidth}
      \begin{itemize}\setlength\itemsep{1.9ex}        
        \item[o] {\cb Overall, climate change leads to negative impacts on water availability, food production, infrastructure and human health}
      \end{itemize}
